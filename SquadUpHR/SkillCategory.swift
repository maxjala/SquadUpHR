...
class SkillCategory {
    ...
    static func fetchInterests() -> [SkillCategory] {
        return [
            SkillCategory(title: "Design", featuredImage: UIImage(named: "desgin")!, color: UIColor(red: 63/255.0, green: 71/255.0, blue: 80/255.0, alpha: 0.8)),
            ...
            SkillCategory(title: "Information Technology", featuredImage: UIImage(named: "desgin")!, color: UIColor(red: 102/255.0, green: 102/255.0, blue: 102/255.0, alpha: 0.8)),
            
            SkillCategory(title: "Education", featuredImage: UIImage(named: "desgin")!, color: UIColor(red: 245/255.0, green: 62/255.0, blue: 40/255.0, alpha: 0.8)),
            SkillCategory(title: "Others", featuredImage: UIImage(named: "desgin")!, color: UIColor(red: 103/255.0, green: 217/255.0, blue: 87/255.0, alpha: 0.8))
